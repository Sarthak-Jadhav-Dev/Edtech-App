...
class ChildClassDetailScreen extends StatelessWidget {
  ...
  const ChildClassDetailScreen({super.key, required this.classId, required this.classData});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(classData['name'] ?? 'Child Course Detail', style: const TextStyle(fontFamily: "Poppins", fontSize: 18)),
